...
open class CenteredCollectionViewFlowLayout: UICollectionViewFlowLayout {
    ...
    override open func invalidateLayout(with context: UICollectionViewLayoutInvalidationContext) {
        ...
        let currentCollectionViewSize: CGSize = collectionView.bounds.size
    ...
    override open func targetContentOffset(
        ...
        case .vertical:
            ...
            if (velocity.y < 0 && offset > 0)
                || (velocity.y > 0 && offset < 0) {
...
///   - animated: Whether the scroll should be performed animated.
    public func scrollToPage(index: Int, animated: Bool) {
        ...
        case .horizontal:
            ...
            proposedContentOffset = CGPoint(x: pageOffset,
        ...
        case .vertical:
            ...
            proposedContentOffset = CGPoint(x: collectionView.contentOffset.x,
                                            y: pageOffset)
...
private extension CenteredCollectionViewFlowLayout {
    ...
    func determineProposedRect(
        ...
        switch scrollDirection {
        case .horizontal:
            origin = CGPoint(x: proposedContentOffset.x,
                             y: collectionView.contentOffset.y)
        case .vertical:
            origin = CGPoint(x: collectionView.contentOffset.x,
